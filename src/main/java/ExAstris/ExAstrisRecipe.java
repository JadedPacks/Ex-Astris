...
public class ExAstrisRecipe {
	...
	public static void registerCraftingRecipes() {
		if(Loader.isModLoaded("RedstoneArsenal")) {
			if(ModData.allowHammerRF) {
				GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ExAstrisItem.HammerRF, 1, 0), " x ", " yx", "y  ", 'x', "ingotElectrumFlux", 'y', new ItemStack(GameRegistry.findItem("RedstoneArsenal", "material"), 1, 193)));
			}
			if(ModData.allowCrookRF) {
				GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ExAstrisItem.CrookRF, 1, 0), "xxy", " x ", "yx ", 'x', new ItemStack(GameRegistry.findItem("RedstoneArsenal", "material"), 1, 192), 'y', "gemCrystalFlux"));
			}
		}
		if(Loader.isModLoaded("Thaumcraft") && ModData.allowDollFreezing && ModData.allowThaumiumbarrel) {
			GameRegistry.addRecipe(new ItemStack(ExAstrisItem.DollFreezing, 1, 0), "aba", "ded", "aca", 'a', Items.snowball, 'b', Items.nether_wart, 'c', Items.redstone, 'd', Items.glowstone_dust, 'e', new ItemStack(GameRegistry.findItem("exnihilo", "doll"), 1, 0));
		}
		if(Loader.isModLoaded("AWWayofTime")) {
			GameRegistry.addRecipe(new ItemStack(ExAstrisItem.UnchargedNetherStar, 1, 0), "aaa", "dbd", "cef", 'a', Items.skull, 'b', Items.quartz, 'c', Items.diamond_axe, 'd', Blocks.soul_sand, 'e', Items.diamond_pickaxe, 'f', Items.diamond_sword);
		}
		if(ModData.allowEndCake) {
			GameRegistry.addRecipe(new ItemStack(ExAstrisBlock.EndCake, 1, 0), "aaa", "bcb", "aaa", 'a', Items.ender_eye, 'b', Items.cake, 'c', Items.golden_apple);
		}
		...
		if(Loader.isModLoaded("RotaryCraft") && ModData.allowStronglyCompressedStone) {
			GameRegistry.addRecipe(new ItemStack(ExAstrisBlock.StronglyCompressedStone, 1, 0), "aaa", "aaa", "aaa", 'a', new ItemStack(Blocks.obsidian, 1, 0));
			GameRegistry.addRecipe(new ItemStack(ExAstrisBlock.StronglyCompressedStone, 1, 1), "aaa", "aaa", "aaa", 'a', new ItemStack(ExAstrisBlock.StronglyCompressedStone, 1, 0));
			GameRegistry.addRecipe(new ItemStack(ExAstrisBlock.StronglyCompressedStone, 1, 2), "aaa", "aaa", "aaa", 'a', new ItemStack(ExAstrisBlock.StronglyCompressedStone, 1, 1));
			GameRegistry.addRecipe(new ItemStack(ExAstrisBlock.QStronglyCompressedStone, 1, 0), "aaa", "aaa", "aaa", 'a', new ItemStack(ExAstrisBlock.StronglyCompressedStone, 1, 2));
		}
		if(Loader.isModLoaded("Metallurgy") && ModData.allowMetallurgyOres) {
	...
	public static void OreRecipeFactory(Block block, Item item) {
		GameRegistry.addRecipe(new ItemStack(block, 1, 0), "aa ", "aa ", "   ", 'a', new ItemStack(item, 1, 0));
		GameRegistry.addRecipe(new ItemStack(block, 1, 1), "aa ", "aa ", "   ", 'a', new ItemStack(item, 1, 1));
		GameRegistry.addRecipe(new ItemStack(block, 1, 2), "aa ", "aa ", "   ", 'a', new ItemStack(item, 1, 2));
	}

	public static void addThermalFoundationRecipes() {
		if(ModData.allowSieveAutomatic) {
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ExAstrisBlock.SieveAutomatic, 1, 0), "aba", "aca", "d d", 'a', "ingotInvar", 'b', new ItemStack(GameRegistry.findItem("exnihilo", "mesh"), 1, 0), 'c', "gearElectrum", 'd', "nuggetInvar"));
		}
		if(ModData.allowUpgrades) {
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ExAstrisItem.sieveUpgradeItem, 2, 0), "aba", "bcb", "aba", 'a', "nuggetElectrum", 'b', "ingotInvar", 'c', "dustPyrotheum"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ExAstrisItem.sieveUpgradeItem, 2, 1), "aba", "bcb", "aba", 'a', "nuggetElectrum", 'b', "ingotInvar", 'c', "gemDiamond"));
		}
		if(ModData.allowHammerAutomatic) {
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ExAstrisBlock.HammerAutomatic, 1, 0), "ada", "aba", "aca", 'a', "ingotInvar", 'd', Blocks.piston, 'c', Blocks.anvil, 'b', Blocks.heavy_weighted_pressure_plate));
		}
	}
	...
	public static void addEnderIORecipes() {
		...
		if(ModData.allowSieveAutomatic) {
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ExAstrisBlock.SieveAutomatic, 1, 0), "aba", "aca", "d d", 'a', "ingotElectricalSteel", 'b', new ItemStack(GameRegistry.findItem("exnihilo", "mesh"), 1, 0), 'c', new ItemStack(GameRegistry.findItem("EnderIO", "itemMachinePart"), 1, 0), 'd', "nuggetElectricalSteel"));
		}
		if(ModData.allowUpgrades) {
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ExAstrisItem.sieveUpgradeItem, 2, 0), "aba", "bcb", "aba", 'a', "nuggetVibrantAlloy", 'b', "ingotRedstoneAlloy", 'c', new ItemStack(GameRegistry.findItem("EnderIO", "itemMaterial"), 1, 7)));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ExAstrisItem.sieveUpgradeItem, 2, 1), "aba", "bcb", "aba", 'a', "nuggetVibrantAlloy", 'b', "ingotRedstoneAlloy", 'c', "gemDiamond"));
		}
		if(ModData.allowHammerAutomatic) {
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ExAstrisBlock.HammerAutomatic, 1, 0), "ada", "aba", "aca", 'a', "ingotDarkSteel", 'd', Blocks.piston, 'c', Blocks.anvil, 'b', Blocks.heavy_weighted_pressure_plate));
		}
	}
}
